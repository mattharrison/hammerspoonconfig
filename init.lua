...
-- Send Window Left
hs.hotkey.bind({"f6ctrl","alt","cmd"}, "Left", function()
...
function sizeup.send_resolution1()
  hs.alert.show("Res 1280x720")
  local s = hs.screen.mainScreen()                     
  s:setMode(1280, 720, 2)
end

hs.hotkey.bind({"cmd", "alt", "shift"}, "1", sizeup.send_resolution1)
...
function sizeup.send_resolution2()
  hs.alert.show("Res 1920x1200")
  local s = hs.screen.mainScreen()                     
  s:setMode(1920, 1200, 2)
end

hs.hotkey.bind({"cmd", "alt", "shift"}, "2", sizeup.send_resolution2)

local keycodes = require("hs.keycodes").map

function sizeup.send_resolution3()
  hs.alert.show(tostring(keycodes["f16"]))
  hs.alert.show("Res 1680x1050")
  local s = hs.screen.mainScreen()                     
  s:setMode(1680, 1050, 2)
end

hs.hotkey.bind({"cmd", "alt", "shift"}, "3", sizeup.send_resolution3)
-- Using Karabiner to remand R_COMMAND to f16


local rightoption = 58  --61
--hs.hotkey.bind({keycodes["f16"], "shift"}, "3", sizeup.send_resolution3)
hs.hotkey.bind(hyper, "3", sizeup.send_resolution3)
hs.hotkey.bind(hyper, "1", sizeup.send_resolution1)

--hs.hotkey.bind({"FN"}, "1", sizeup.send_resolution1)

--hs.hotkey.bind({rightoption}, "1", sizeup.send_resolution1)
